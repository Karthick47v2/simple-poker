...
void gameDisplay() {
	...
	if ((((abs(iniPacManX - redGhostX) <= 10) && iniPacManY == redGhostY) || ((abs(iniPacManY - redGhostY) <= 10) && iniPacManX == redGhostX) || ((abs(iniPacManX - greenGhostX) <= 10) && iniPacManY == greenGhostY) || ((abs(iniPacManY - greenGhostY) <= 10) && iniPacManX == greenGhostX) || ((abs(iniPacManX - blueGhostX) <= 10) && iniPacManY == blueGhostY) || ((abs(iniPacManY - blueGhostY) <= 10) && iniPacManX == blueGhostX) || ((abs(iniPacManX - cyanGhostX) <= 10) && iniPacManY == cyanGhostY) || ((abs(iniPacManY - cyanGhostY) <= 10) && iniPacManX == cyanGhostX) || ((abs(iniPacManX - extraGhostX) <= 10) && iniPacManY == extraGhostY) || ((abs(iniPacManY - extraGhostY) <= 10) && iniPacManX == extraGhostX)) && isPoweredUp == 0) {
		//red
		if ((abs(iniPacManX - redGhostX) <= 10) && iniPacManY == redGhostY) {
			if (abs(iniPacManX - (redGhostX + 1)) == ((iniPacManX - redGhostX) - 1) && gameMap[redGhostY][(redGhostX + 1)] != a) {
				redGhostX++;
			}
		...
		if ((abs(iniPacManY - redGhostY) <= 10) && iniPacManX == redGhostX) {
			if (abs(iniPacManY - (redGhostY + 1)) == ((iniPacManY - redGhostY) - 1) && gameMap[redGhostY + 1][(redGhostX)] != a) {
				redGhostY++;
			}
		...
		//green
		if ((abs(iniPacManX - greenGhostX) <= 10) && iniPacManY == greenGhostY) {
			if (abs(iniPacManX - (greenGhostX + 1)) == ((iniPacManX - greenGhostX) - 1) && gameMap[greenGhostY][(greenGhostX + 1)] != a) {
				greenGhostX++;
			}
		...
		if ((abs(iniPacManY - greenGhostY) <= 10) && iniPacManX == greenGhostX) {
			if (abs(iniPacManY - (greenGhostY + 1)) == ((iniPacManY - greenGhostY) - 1) && gameMap[greenGhostY + 1][(greenGhostX)] != a) {
				greenGhostY++;
			}
			else if (gameMap[redGhostY - 1][(redGhostX)] != a) {
				greenGhostY--;
		...
		//blue
		if ((abs(iniPacManX - blueGhostX) <= 10) && iniPacManY == blueGhostY) {
			if (abs(iniPacManX - (blueGhostX + 1)) == ((iniPacManX - blueGhostX) - 1) && gameMap[blueGhostY][(blueGhostX + 1)] != a) {
				blueGhostX++;
			}
		...
		if ((abs(iniPacManY - blueGhostY) <= 10) && iniPacManX == blueGhostX) {
			if (abs(iniPacManY - (blueGhostY + 1)) == ((iniPacManY - blueGhostY) - 1) && gameMap[blueGhostY + 1][(blueGhostX)] != a) {
				blueGhostY++;
			}
		...
		//cyan
		if ((abs(iniPacManX - cyanGhostX) <= 10) && iniPacManY == cyanGhostY) {
			if (abs(iniPacManX - (cyanGhostX + 1)) == ((iniPacManX - cyanGhostX) - 1) && gameMap[cyanGhostY][(cyanGhostX + 1)] != a) {
				cyanGhostX++;
			}
		...
		if ((abs(iniPacManY - cyanGhostY) <= 10) && iniPacManX == cyanGhostX) {
			if (abs(iniPacManY - (cyanGhostY + 1)) == ((iniPacManY - cyanGhostY) - 1) && gameMap[cyanGhostY + 1][(cyanGhostX)] != a) {
				cyanGhostY++;
			}
		...
		//extra
		if ((abs(iniPacManX - extraGhostX) <= 10) && iniPacManY == extraGhostY) {
			if (abs(iniPacManX - (extraGhostX + 1)) == ((iniPacManX - extraGhostX) - 1) && gameMap[extraGhostY][(extraGhostX + 1)] != a) {
				extraGhostX++;
			}
		...
		if ((abs(iniPacManY - extraGhostY) <= 10) && iniPacManX == extraGhostX) {
			if (abs(iniPacManY - (extraGhostY + 1)) == ((iniPacManY - extraGhostY) - 1) && gameMap[extraGhostY + 1][(extraGhostX)] != a) {
				extraGhostY++;
			}
